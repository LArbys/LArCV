...
#include "../Reco3D/AStar3DAlgoProton.h"
...
namespace larcv {
  ...
  //--------------------------------------------------------------- NEED THIS
  void ChimeraMachinery::tellMe(std::string s, int verboseMin = 0){ 
    if(_verbose >= verboseMin) std::cout << s << std::endl;
    }
    //______________________________________________________
    void ChimeraMachinery::SetTimeAndWireBoundsProtonsErez(){
    ...
    //______________________________________________________
    void ChimeraMachinery::SetTimeAndWireBounds(){
        time_bounds.clear();
        wire_bounds.clear();
    ...
    //______________________________________________________
    void ChimeraMachinery::SetTimeAndWireBounds(TVector3 pointStart, TVector3 pointEnd){
    ...
    //______________________________________________________
    void ChimeraMachinery::SetTimeAndWireBounds(std::vector<TVector3> points){
    ...
    //______________________________________________________NEEDED FOR HORIZONTAL
    void ChimeraMachinery::SetTimeAndWireBounds(std::vector<TVector3> points, std::vector<larcv::ImageMeta> meta){
        time_bounds.clear();
        wire_bounds.clear();
        //time_bounds.reserve(3);
        //wire_bounds.reserve(3);
    ...
    //______________________________________________________
    void ChimeraMachinery::Reconstruct(){
        _eventTreated++;
    ...
    //______________________________________________________
    void ChimeraMachinery::EnhanceDerivative(){
    ...
    //______________________________________________________
    void ChimeraMachinery::MaskTrack(){
        tellMe("MaskTrack",0);
    ...
    //______________________________________________________NEEDED FOR HORIZONTAL
    void ChimeraMachinery::MaskVertex(){
        tellMe("MaskVertex()",0);
        double shellMask = 4;
        double MaskedValue = 0;
    ...
    //______________________________________________________
    void ChimeraMachinery::ReconstructVertex(){
    ...
    //______________________________________________________
    void ChimeraMachinery::ConstructTrack(){
    ...
    //______________________________________________________
    void ChimeraMachinery::ConstructVertex(){
    ...
    //______________________________________________________
    void ChimeraMachinery::CleanUpVertex(){
    ...
    //______________________________________________________
    void ChimeraMachinery::DiagnoseVertex(){
    ...
    //______________________________________________________
    void ChimeraMachinery::DiagnoseTrack(size_t itrack){
    ...
    //______________________________________________________
    void ChimeraMachinery::ReconstructEvent(){
    ...
    //______________________________________________________
    void ChimeraMachinery::ImprovedCluster(){
    ...
    //______________________________________________________
    void ChimeraMachinery::PreSortAndOrderPoints(){
    ...
    //______________________________________________________
    void ChimeraMachinery::SortAndOrderPoints(){
        //try and get a "track"
    ...
    //______________________________________________________
    void ChimeraMachinery::Make3DpointList(){
    ...
    //______________________________________________________
    void ChimeraMachinery::ComputedQdX(){
    ...
    //______________________________________________________
    void ChimeraMachinery::ComputeNewdQdX(){
    ...
    //______________________________________________________
    std::vector<double> ChimeraMachinery::ComputeTruncateddQdX(double nDevs=1){
    ...
    //______________________________________________________NEEDED FOR HORIZONTAL
    bool ChimeraMachinery::IsGoodVertex(){
    ...
    //______________________________________________________
    void ChimeraMachinery::CreateDataImage(std::vector<larlite::wire> wire_v){
    ...
    //______________________________________________________
    void ChimeraMachinery::FeedTrack(std::vector<TVector3> newTrack){
        tellMe("FeedTrack",0);
    ...
    //______________________________________________________
    void ChimeraMachinery::DrawTrack(){
        tellMe("DrawTrack",0);
        TH2D *hImage[3];
        TGraph *gTrack[3];
        TGraph *gStartNend[3];
    ...
    void ChimeraMachinery::DrawVertex(){
    ...
    void ChimeraMachinery::DrawVertexVertical(){
        ...
        for(size_t i=0;i<_vertexTracks.size();i++){
            TGraph *gTrack[3];
            double x_pixel, y_pixel;
            for(size_t iPlane=0;iPlane<3;iPlane++){gTrack[iPlane] = new TGraph();} // red dots **
            for(size_t iPlane=0;iPlane<3;iPlane++){
    ...
    //______________________________________________________NEED THIS
    void ChimeraMachinery::DrawVertexHorizontal(){
    ...
    //______________________________________________________
    void ChimeraMachinery::DrawVertex3D(){
    ...
    //______________________________________________________NEED THIS
    void ChimeraMachinery::ReadSplineFile(){
    ...
    //______________________________________________________NEED THIS FUNCTION
    void ChimeraMachinery::SetSplineFile(const std::string& fpath) {
        _spline_file = fpath;
        std::cout << "set spline file=" << _spline_file << std::endl;
    }
    //______________________________________________________
    void ChimeraMachinery::DrawROI(){
    ...
    //______________________________________________________
    void ChimeraMachinery::RegularizeTrack(){
    ...
    //______________________________________________________
    void ChimeraMachinery::ComputeLength(){
    ...
    //______________________________________________________
    double ChimeraMachinery::ComputeLength(int node){
    ...
    //______________________________________________________NEED THIS
    void ChimeraMachinery::WorldInitialization(){
        gWorld = new TGraph2D();
    ...
    //______________________________________________________
    void ChimeraMachinery::ShaveTracks(){
    ...
    //______________________________________________________
    bool ChimeraMachinery::CheckEndPointsInVolume(TVector3 point){
    ...
    //______________________________________________________NEED THIS
    bool ChimeraMachinery::initialize() {
        tellMe("initialize()",0);
        ReadSplineFile();
        _eventTreated = 0;
        _eventSuccess = 0;
    ...
    //______________________________________________________NEED THIS
    bool ChimeraMachinery::finalize() {
        tellMe("Finalizing",0);
        return true;
    }
    //______________________________________________________
    bool ChimeraMachinery::ArePointsEqual(TVector3 A, TVector3 B){
        if((A-B).Mag() < 2)return true;
        else return false;
    }
    //______________________________________________________
    bool ChimeraMachinery::CheckEndPoints(std::vector< std::pair<int,int> > endPix){
    ...
    //______________________________________________________
    bool ChimeraMachinery::IsInSegment(TVector3 A, TVector3 B, TVector3 C){
        if((C-A).Dot(B-A)/(B-A).Mag() > 0 && (C-A).Dot(B-A)/(B-A).Mag() < 1) return true;
        else return false;
    }
    //______________________________________________________
    bool ChimeraMachinery::IsTrackIn(std::vector<TVector3> trackA, std::vector<TVector3> trackB){
    ...
    //______________________________________________________
    double ChimeraMachinery::EvalMinDist(TVector3 point){
    ...
    //______________________________________________________
    double ChimeraMachinery::EvalMinDist(TVector3 point, std::vector< std::pair<int,int> > endPix){
        tellMe(Form("EvalMinDist : (%f,%f,%f)",point.X(),point.Y(),point.Z()),2);
        double minDist = 1e9;
        //double minDistplane[3] = {1e9,1e9,1e9};
        for(size_t iPlane = 0;iPlane<3;iPlane++){
    ...
    //______________________________________________________
    double ChimeraMachinery::X2Tick(double x, size_t plane) const {
    ...
    //______________________________________________________
    double ChimeraMachinery::Tick2X(double tick, size_t plane) const{
        //auto ts = larutil::TimeService::GetME();
        auto larp = larutil::LArProperties::GetME();
    ...
    //______________________________________________________
    double ChimeraMachinery::GetEnergy(std::string partType, double Length = -1){
    ...
    //______________________________________________________
    std::vector< std::vector<double> > ChimeraMachinery::GetEnergies(){
    ...
    //______________________________________________________
    std::vector<double> ChimeraMachinery::GetAverageIonization(double distAvg){
    ...
    //______________________________________________________
    std::vector<double> ChimeraMachinery::GetAverageIonization_Yplane(double distAvg){
    ...
    //______________________________________________________
    std::vector<double> ChimeraMachinery::GetTotalIonization(double distAvg){
    ...
    //______________________________________________________
    std::vector<double> ChimeraMachinery::GetTotalIonization_Yplane(double distAvg){
        tellMe(Form("GetTotalIonization(%.1f)",distAvg),0);
        larlite::geo::View_t views[3] = {larlite::geo::kU,larlite::geo::kV,larlite::geo::kZ};
        if(_vertex_dQdX_v.size()!=_vertexTracks.size()){_vertex_dQdX_v.clear();ComputeNewdQdX();}
        std::vector<double> IonizatioPerTrack(_vertexTracks.size(),0);
    ...
    //______________________________________________________
    std::vector< std::vector<double> >  ChimeraMachinery::GetTotalPixADC(){
    ...
    //______________________________________________________
    std::vector< std::vector<double> >  ChimeraMachinery::GetTotalPixADC(float tkLen){
        tellMe("GetTotalPixADC()",0);
    ...
    //______________________________________________________
    std::vector<double> ChimeraMachinery::GetVertexLength(){
    ...
    //______________________________________________________
    void ChimeraMachinery::Add_SCE_to_Tracks(){
    ...
    //______________________________________________________
    void ChimeraMachinery::ComputeClosestWall_SCE(){
    ...
    //______________________________________________________
    std::vector<std::vector<double> > ChimeraMachinery::GetVertexAngle(double dAverage = 15, double dMin = 0){
    ...
    //______________________________________________________
    std::vector<double> ChimeraMachinery::GetOldVertexAngle(double dAverage = 5){
        // Find if tracks are back to back at the vertex point
    ...
    //______________________________________________________
    double ChimeraMachinery::GetTotalDepositedCharge(){
    ...
    //______________________________________________________NEEDED FOR HORIZONTAL
    double ChimeraMachinery::GetDist2line(TVector3 A, TVector3 B, TVector3 C){
        TVector3 CrossProd = (B-A).Cross(C-A);
        TVector3 U = B-A;
        return CrossProd.Mag()/U.Mag();
    }
    //______________________________________________________
    double ChimeraMachinery::GetDist2track(TVector3 thisPoint, std::vector<TVector3> thisTrack){
        double dist = 15000;
        if(thisTrack.size() > 2){
    ...
    //______________________________________________________
    TVector3 ChimeraMachinery::CheckEndPoints(TVector3 point){
    ...
    //______________________________________________________
    TVector3 ChimeraMachinery::GetFurtherFromVertex(){
    ...
    //______________________________________________________
    TVector3 ChimeraMachinery::CheckEndPoints(TVector3 point, std::vector< std::pair<int,int> > endPix){
        tellMe(Form("start point : (%f,%f,%f)",point.X(),point.Y(),point.Z()),2);
        double dR = 0.1;
        double closeEnough = 4;
    ...
    //______________________________________________________
    std::vector<TVector3> ChimeraMachinery::FitBrokenLine(){
    ...
    //______________________________________________________
    std::vector<TVector3> ChimeraMachinery::OrderList(std::vector<TVector3> list){
    ...
    //______________________________________________________
    std::vector<TVector3> ChimeraMachinery::GetOpenSet(TVector3 newPoint, double dR){
    ...
    //______________________________________________________
    std::vector<TVector3> ChimeraMachinery::GetOpenSet(TVector3 newPoint, int BoxSize, double dR){
        std::vector<TVector3> openSet;
    ...
    //______________________________________________________NEEDED FOR HORIZONTAL
    std::vector<larcv::Image2D> ChimeraMachinery::CropFullImage2bounds(std::vector< std::vector<TVector3> > _vertex_v){
    ...
    //______________________________________________________
    void ChimeraMachinery::ClearDeadWireList(){
        if(_deadWires_v.size()!=0)_deadWires_v.clear();
    }
    //______________________________________________________
    void ChimeraMachinery::MakeDeadWireList(){
    ...
    //______________________________________________________NEEDED FOR HORIZONTAL
    std::vector<larcv::Image2D> ChimeraMachinery::CropFullImage2bounds(std::vector<TVector3> EndPoints){
	...
	// Defining image2d **
	    ...
	    // image is upside down (backwards in time dimension) **
            for(size_t icol = 0;icol<newImage.meta().cols();icol++){
                for(size_t irow = 0;irow<newImage.meta().rows();irow++){
                    ...
                    else{invertedImage.set_pixel(newImage.meta().rows()-irow-1, icol,0);} // set pixel as 0 **
                }
            }
            data_images.push_back(invertedImage);
	    
	    // tagger not being used right now (might be beter after ralitsa) **
    ...
    //______________________________________________________NEED THIS
    std::vector<larcv::Image2D> ChimeraMachinery::GetFullImage(){
        std::vector<larcv::ImageMeta> Full_meta_v(3);
        for(size_t iPlane = 0;iPlane<3;iPlane++){Full_meta_v[iPlane] = original_full_image_v[iPlane].meta();}
  ...
  //______________________________________________________
    ...
    //-------------------------------------------------------
    std::vector<int> ChimeraMachinery::GetRecoGoodness(){
    ...
    //-------------------------------------------------------
    std::vector<int> ChimeraMachinery::GetVtxQuality(){
    ...
    //-------------------------------------------------------
    void ChimeraMachinery::RecoverFromFail(){
    ...
    //-------------------------------------------------------
    void ChimeraMachinery::FillInTrack(){
        std::vector<TVector3> newTrack;
        if(newTrack.size() != 0)newTrack.clear();
        //if(_3DTrack.back()!= end_pt)_3DTrack.push_back(end_pt);
        for(size_t ipoint=0;ipoint<_3DTrack.size()-1;ipoint++){
    ...
    //-------------------------------------------------------
    std::vector<TVector3>   ChimeraMachinery::GetEndPoints(){
    ...
    //_______________________________________________________NEED THIS
    void ChimeraMachinery::Get3DtracksFromLarlite(){
    ...
    //______________________________________________________
    bool ChimeraMachinery::IsGoodTrack(){
    ...
    //______________________________________________________
    void ChimeraMachinery::FeedVtxGoodness(std::vector<bool> goodTracks_v){
    ...
    //______________________________________________________
    void ChimeraMachinery::MakeVertexTrack(){
    ...
    //______________________________________________________
    void ChimeraMachinery::MakeTrack(){
        tellMe("MakeTrack()",0);
    ...
    //______________________________________________________
    void ChimeraMachinery::DumpTrack(){
        tellMe("_________",0);
        tellMe("DumpTrack",0);
        tellMe("_________",0);
    ...
    //______________________________________________________
    void ChimeraMachinery::TellMeRecoedPath(){
        for(size_t iPlane = 0;iPlane<3;iPlane++){
