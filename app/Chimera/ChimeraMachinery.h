/**
 * \file ChimeraMachinery.h
 *
 * \ingroup Polina Abratenko
 *
 * \brief Class def header for a class ChimeraMachinery
 *
...
#ifndef LARLITE_ChimeraMachinery_H
#define LARLITE_ChimeraMachinery_H
