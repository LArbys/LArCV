...
namespace larcv {
  ...
  // const std::vector<larcv::Image2D>& DLCosmicTagVertexReco::get_image2d(IOManager& mgr, std::string producer) {
  ...
  bool DLCosmicTagVertexReco::process(IOManager& mgr)
  {
    ...
    //   _DLCosmicTagVertexRecoMaker.ConstructCosmicImage(mgr, _thrumu_producer, _tags_datatype, adc_image_v, _thrumu_image_v);
    //   _DLCosmicTagVertexRecoMaker.ConstructCosmicImage(mgr, _stopmu_producer, _tags_datatype, adc_image_v, _stopmu_image_v);
  ...
  // bool DLCosmicTagVertexReco::StoreParticles(IOManager& iom,
  ...
  bool DLCosmicTagVertexReco::Reconstruct(const std::vector<larcv::Image2D>& adc_image_v,
				...
				const std::vector<larcv::Image2D>& chstat_image_v)
  {
    ...
    // for(auto& img_data : _DLCosmicTagVertexRecoMaker.ExtractImage(adc_image_v)) {
    ...
    //   for(auto& img_data : _DLCosmicTagVertexRecoMaker.ExtractImage(track_image_v))  { 
    ...
    //   for(auto& img_data : _DLCosmicTagVertexRecoMaker.ExtractImage(shower_image_v)) {
    ...
    //   for(auto& img_data : _DLCosmicTagVertexRecoMaker.ExtractImage(stopmu_image_v)) {
    ...
    //   for(auto& img_data : _DLCosmicTagVertexRecoMaker.ExtractImage(thrumu_image_v)) {
    ...
    //   for(auto& img_data : _DLCosmicTagVertexRecoMaker.ExtractImage(chstat_image_v)) {
  ...
  void DLCosmicTagVertexReco::Process() {
    _alg_mgr.Process();
  }
