/**
 * \file ImageFillerBase.h
 *
 * \ingroup Package_Name
 * 
 * \brief Class def header for a class ImageFillerBase
 *
 * @author Rui A.
 */
...
/** \addtogroup Package_Name
    ...
    @{*/
#ifndef __IMAGEFILLERBASE_H__
#define __IMAGEFILLERBASE_H__

#include "Processor/ProcessBase.h"
#include "DataFormat/Image2D.h"
#include "DataFormat/ROI.h"
namespace larcv {
  class ThreadImageFiller;

  /**
     \class ProcessBase
     User defined class ImageFillerBase ... these comments are used to generate
     doxygen documentation!
  */
  class ImageFillerBase : public ProcessBase {
    friend class ThreadImageFiller;
  public:
  ...
  public:
    ...
    /// Default constructor
    ImageFillerBase(const std::string name="ImageFillerBase");
  ...
  protected:
    ...
    virtual void fill_entry_data (const larcv::EventBase* image)=0;
