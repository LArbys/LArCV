...
class ROOTData:
    def __init__(self):
        ...
        self.reco_proton_mean_pixel_dist[0] = array( 'f', [ kINVALID_FLOAT ] )
        self.reco_proton_width[0] = array( 'f', [ kINVALID_FLOAT ] )
        self.reco_proton_area[0] = array( 'f', [ kINVALID_FLOAT ] )
        self.reco_proton_qsum[0] = array( 'f', [ kINVALID_FLOAT ] )
        self.reco_proton_shower_frac[0] = array( 'f', [ kINVALID_FLOAT ] )
        ...
        self.reco_electron_mean_pixel_dist[0] = array( 'f', [ kINVALID_FLOAT ] )
        self.reco_electron_width[0] = array( 'f', [ kINVALID_FLOAT ] )
        self.reco_electron_area[0] = array( 'f', [ kINVALID_FLOAT ] )
        self.reco_electron_qsum[0] = array( 'f', [ kINVALID_FLOAT ] )
        self.reco_electron_shower_frac[0] = array( 'f', [ kINVALID_FLOAT ] )
