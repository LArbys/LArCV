...
#
{}_ass_df = pd.read_pickle(os.path.join(BASE_PATH,"ll_dump","{}_post_nue.pkl",format(name)))
print "\t>>> Loaded",{}_ass_df.index.size,"post {} assumption data <<<"
print "Events.................",len({}_ass_df.groupby(rse))
print "...good cROI counter...",len({}_ass_df.query("good_croi_ctr>0").groupby(rse))
print "...reco................",len({}_ass_df.query("num_vertex>0").groupby(rse))
print
scedr=5
print "Good vertices scedr<{}".format(scedr)
print "...total..........",{}_ass_df.query("num_vertex>0").query("scedr<5").index.size
print "...events.........",len({}_ass_df.query("num_vertex>0").query("scedr<5").groupby(rse))
print "Bad vertices scedr>{}".format(scedr)
print "...total..........",{}_ass_df.query("num_vertex>0").query("scedr>@scedr").index.size
print "...events.........",len({}_ass_df.query("num_vertex>0").query("scedr>@scedr").groupby(rse))
print
print
