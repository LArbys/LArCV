...
namespace larcv {
  ...
  void SSNetEventAna::initialize()
  {
    ...
    _tree->Branch("avg_trk_pixel_val0", &_avg_trk_pixel_val0, "_avg_trk_pixel_val0/F");
    _tree->Branch("avg_trk_pixel_val1", &_avg_trk_pixel_val1, "_avg_trk_pixel_val1/F");
    _tree->Branch("avg_trk_pixel_val2", &_avg_trk_pixel_val2, "_avg_trk_pixel_val2/F");

    _tree->Branch("std_trk_pixel_val0", &_std_trk_pixel_val0, "_std_trk_pixel_val0/F");
    _tree->Branch("std_trk_pixel_val1", &_std_trk_pixel_val1, "_std_trk_pixel_val1/F");
    _tree->Branch("std_trk_pixel_val2", &_std_trk_pixel_val2, "_std_trk_pixel_val2/F");

    _tree->Branch("tot_trk_pixel_val0", &_tot_trk_pixel_val0, "_tot_trk_pixel_val0/F");
    _tree->Branch("tot_trk_pixel_val1", &_tot_trk_pixel_val1, "_tot_trk_pixel_val1/F");
    _tree->Branch("tot_trk_pixel_val2", &_tot_trk_pixel_val2, "_tot_trk_pixel_val2/F");

    _tree->Branch("avg_trk_score0", &_avg_trk_score0, "_avg_trk_score0/F");
    _tree->Branch("avg_trk_score1", &_avg_trk_score1, "_avg_trk_score1/F");
    _tree->Branch("avg_trk_score2", &_avg_trk_score2, "_avg_trk_score2/F");

    _tree->Branch("std_trk_score0", &_std_trk_score0, "_std_trk_score0/F");
    _tree->Branch("std_trk_score1", &_std_trk_score1, "_std_trk_score1/F");
    _tree->Branch("std_trk_score2", &_std_trk_score2, "_std_trk_score2/F");

    _tree->Branch("n_shr_pixel0",&_n_shr_pixel0,"_n_shr_pixel0/F");
    _tree->Branch("n_shr_pixel1",&_n_shr_pixel1,"_n_shr_pixel1/F");
    _tree->Branch("n_shr_pixel2",&_n_shr_pixel2,"_n_shr_pixel2/F");

    _tree->Branch("avg_shr_pixel_val0", &_avg_shr_pixel_val0, "_avg_shr_pixel_val0/F");
    _tree->Branch("avg_shr_pixel_val1", &_avg_shr_pixel_val1, "_avg_shr_pixel_val1/F");
    _tree->Branch("avg_shr_pixel_val2", &_avg_shr_pixel_val2, "_avg_shr_pixel_val2/F");

    _tree->Branch("std_shr_pixel_val0", &_std_shr_pixel_val0, "_std_shr_pixel_val0/F");
    _tree->Branch("std_shr_pixel_val1", &_std_shr_pixel_val1, "_std_shr_pixel_val1/F");
    _tree->Branch("std_shr_pixel_val2", &_std_shr_pixel_val2, "_std_shr_pixel_val2/F");

    _tree->Branch("tot_shr_pixel_val0", &_tot_shr_pixel_val0, "_tot_shr_pixel_val0/F");
    _tree->Branch("tot_shr_pixel_val1", &_tot_shr_pixel_val1, "_tot_shr_pixel_val1/F");
    _tree->Branch("tot_shr_pixel_val2", &_tot_shr_pixel_val2, "_tot_shr_pixel_val2/F");

    _tree->Branch("avg_shr_score0", &_avg_shr_score0, "_avg_shr_score0/F");
    _tree->Branch("avg_shr_score1", &_avg_shr_score1, "_avg_shr_score1/F");
    _tree->Branch("avg_shr_score2", &_avg_shr_score2, "_avg_shr_score2/F");

    _tree->Branch("std_shr_score0", &_std_shr_score0, "_std_shr_score0/F");
    _tree->Branch("std_shr_score1", &_std_shr_score1, "_std_shr_score1/F");
    _tree->Branch("std_shr_score2", &_std_shr_score2, "_std_shr_score2/F");

    _tree->Branch("n_adcpixel0",&_n_adc_pixel0,"_n_adc_pixel0/F");
    _tree->Branch("n_adcpixel1",&_n_adc_pixel1,"_n_adc_pixel1/F");
    _tree->Branch("n_adcpixel2",&_n_adc_pixel2,"_n_adc_pixel2/F");

    _tree->Branch("avg_adc_pixel_val0", &_avg_adc_pixel_val0, "_avg_adc_pixel_val0/F");
    _tree->Branch("avg_adc_pixel_val1", &_avg_adc_pixel_val1, "_avg_adc_pixel_val1/F");
    _tree->Branch("avg_adc_pixel_val2", &_avg_adc_pixel_val2, "_avg_adc_pixel_val2/F");

    _tree->Branch("std_adc_pixel_val0", &_std_adc_pixel_val0, "_std_adc_pixel_val0/F");
    _tree->Branch("std_adc_pixel_val1", &_std_adc_pixel_val1, "_std_adc_pixel_val1/F");
    _tree->Branch("std_adc_pixel_val2", &_std_adc_pixel_val2, "_std_adc_pixel_val2/F");

    _tree->Branch("tot_adc_pixel_val0", &_tot_adc_pixel_val0, "_tot_adc_pixel_val0/F");
    _tree->Branch("tot_adc_pixel_val1", &_tot_adc_pixel_val1, "_tot_adc_pixel_val1/F");
    _tree->Branch("tot_adc_pixel_val2", &_tot_adc_pixel_val2, "_tot_adc_pixel_val2/F");
  ...
  bool SSNetEventAna::process(IOManager& mgr) 
  {
	...
	tot_adc_pixel_val += adc_vec[ix];
      ...
      for(size_t ix=0; ix < shr_vec.size(); ++ix) {
	...
	if (shr_vec[ix] > _threshold)  {
      ...
      avg_trk_score /= n_trk_pixel;
      avg_shr_score /= n_shr_pixel;
      ...
      for(size_t ix=0; ix<adc_vec.size(); ++ix) {
	if (adc_vec[ix] < _threshold) continue;
	std_adc_pixel_val += adc_vec[ix] - avg_adc_pixel_val;
	std_adc_pixel_val *= std_adc_pixel_val;
      }

      for(size_t ix=0; ix < shr_vec.size(); ++ix) {
	if (trk_vec[ix] > _threshold) {
	  std_trk_pixel_val += trk_vec[ix] - avg_trk_pixel_val;
	  std_trk_score     += trk_score_vec[ix] - avg_trk_score;
	  std_trk_pixel_val *= std_trk_pixel_val;
	  std_trk_score     *= std_trk_score;
	}
	if (shr_vec[ix] > _threshold)  {
	  std_shr_pixel_val += shr_vec[ix] - avg_shr_pixel_val;
	  std_shr_score     += shr_score_vec[ix] - avg_shr_score;
	  std_shr_pixel_val *= std_shr_pixel_val;
	  std_shr_score     *= std_shr_score;
	}
      }
      ...
      std_trk_score /= n_trk_pixel - 1;
      std_shr_score /= n_shr_pixel - 1;
