...
namespace larcv {
     ...
     */
    class TrackerEventDisplay : public ProcessBase {
     ...
     */
    class TrackerEventDisplayProcessFactory : public ProcessFactoryBase {
    public:
        /// ctor
        TrackerEventDisplayProcessFactory() { ProcessFactory::get().add_factory("TrackerEventDisplay",this); }
        /// dtor
        ~TrackerEventDisplayProcessFactory() {}
        /// creation method
        ProcessBase* create(const std::string instance_name) { return new TrackerEventDisplay(instance_name); }
