...
if len(sys.argv) != 13:
    ...
    print "FLASH_ANA  = str(sys.argv[10]) -- flash_ana"
    print "DEDX_ANA   = str(sys.argv[11]) -- track_dir_ana"
    print "OUTDIR     = str(sys.argv[12])"
    print 
    sys.exit(1)
...
FLASH_ANA  = str(sys.argv[10])
DEDX_ANA   = str(sys.argv[11])
