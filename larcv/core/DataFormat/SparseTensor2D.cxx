#ifndef __LARCV_CORE_DATAFORMAT_SPARSETENSOR2D_CXX__
#define __LARCV_CORE_DATAFORMAT_SPARSETENSOR2D_CXX__
...
namespace larcv {
  ...
  const Voxel& SparseTensor2D::close(VoxelID_t id, double distance, const larcv::ImageMeta& meta) const
  {
    ...
    Voxel invalid(kINVALID_VOXEL);
    Voxel& final_vox = invalid;
