  ...
  int NumpyArrayFloat::store( PyObject* array )
  {
    ...
    if ( ndims==1 ) {
      ...
      if ( PyArray_AsCArray( &array, (void*)&carray, dims, ndims, descr )<0 ) {
        throw std::runtime_error( "TrainingData::store_array - failed to load 1D numpy array" );
      }
      ...
      if ( err<0 ) {
        ...
        errmsg << "NumpyArrayFloatFloat::store - failed to load 2D numpy array. code=" << err << std::endl;
      ...
      float*** carray = nullptr;
      if ( PyArray_AsCArray( &array, (void*)&carray, dims, ndims, descr )<0 ) {
        throw std::runtime_error( "NumpyArrayFloatFloat::store - failed to load 3D numpy array" );
      }
